...
export default function Update() { 
    ...
    const sendDataToAPI = () => {
        axios.put(`https://62fe9f5a41165d66bfc33c26.mockapi.io/Crud/${ID}`, formik.values)
    }

    useEffect(() => {
        formik.values.email=localStorage.getItem('email');
        formik.values.name=localStorage.getItem('name');
        formik.values.message=localStorage.getItem('message');
