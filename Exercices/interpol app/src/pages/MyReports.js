...
const MyReports = () => {
  return (
    <div className="my-reports-container">
      ...
      <div className="my-reports-cards-container">
        <ReportsCard />
        <ReportsCard />
        <ReportsCard />
        <ReportsCard />
      ...
      {/* {modal && (
        <div className="modal-reports">
          ...
          <div className="modal-details">
            ...
            <div className="nationality-container modal-nationality">
              <h5>Nationality:</h5>
              <select>
            ...
            <div className="modal-notice-color">
              <h5>Notice color:</h5>
              <select>
          ...
          <div className="modal-footer-btns">
            ...
            <button className="btn-danger">Save Changes</button>
          </div>
        </div>
      )} */}
    </div>
