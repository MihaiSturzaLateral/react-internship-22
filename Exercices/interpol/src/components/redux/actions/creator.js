...
export const get_personsAction = (button) => {
  return (dispatch) => {
    axios
      ...
      .then((response) => {
        dispatch(get_persons(response.data._embedded.notices));
      })
      .catch((error) => {
    ...
    axios
      ...
      .then(
        axios.spread((...response) => {
          ...
          dispatch(get_all(responseOne.data._embedded.notices));
          dispatch(get_all(responseTwo.data._embedded.notices));
        })
      )
      .catch((error) => {
